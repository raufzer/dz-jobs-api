...
// @Success 201 {object} response.Response{Data=responseCandidate.CertificationResponse} "Certification created successfully"
...
// @Success 200 {object} response.Response{Data=responseCandidate.CertificationsResponseData} "Certifications retrieved successfully"
// @Failure 400 {object} response.Response "Invalid input"
// @Failure 401 {object} response.Response "Unauthorized"
// @Failure 403 {object} response.Response "Forbidden"
// @Failure 404 {object} response.Response "Candidate not found"
...
func (c *CandidateCertificationsController) GetCertifications(ctx *gin.Context) {
	...
	ctx.JSON(http.StatusOK, response.Response{
        ...
        Data:     responseCandidate.ToCertificationsResponse(certifications),
	})
}
