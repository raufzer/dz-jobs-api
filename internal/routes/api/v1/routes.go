...
func RegisterRoutes(router *gin.Engine, authController *controllers.AuthController, userController *controllers.UserController, recruiterController *controllers.RecruiterController, candidateController *candidateControllers.CandidateController, personalInfoController *candidateControllers.CandidatePersonalInfoController, educationController *candidateControllers.CandidateEducationController, experienceController *candidateControllers.CandidateExperienceController, skillsController *candidateControllers.CandidateSkillsController, certificationsController *candidateControllers.CandidateCertificationsController, portfolioController *candidateControllers.CandidatePortfolioController, appConfig *config.AppConfig) {
	// Base path
	...
	RegisterProtectedRoutes(protected, userController, recruiterController, candidateController, personalInfoController, educationController, experienceController, skillsController, certificationsController, portfolioController)
}
...
func RegisterProtectedRoutes(router *gin.RouterGroup, userController *controllers.UserController, recruiterController *controllers.RecruiterController, candidateController *candidateControllers.CandidateController, personalInfoController *candidateControllers.CandidatePersonalInfoController, educationController *candidateControllers.CandidateEducationController, experienceController *candidateControllers.CandidateExperienceController, skillsController *candidateControllers.CandidateSkillsController, certificationsController *candidateControllers.CandidateCertificationsController, portfolioController *candidateControllers.CandidatePortfolioController) {
	...
	RegisterCandidateRoutes(candidateGroup, candidateController, personalInfoController, educationController, experienceController, skillsController, certificationsController, portfolioController)
