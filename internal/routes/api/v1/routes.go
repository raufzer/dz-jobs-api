...
func RegisterRoutes(router *gin.Engine, authController *controllers.AuthController, userController *controllers.UserController, candidateController *candidateControllers.CandidateController, personalInfoController *candidateControllers.CandidatePersonalInfoController, educationController *candidateControllers.CandidateEducationController, experienceController *candidateControllers.CandidateExperienceController, skillsController *candidateControllers.CandidateSkillsController, certificationsController *candidateControllers.CandidateCertificationsController, portfolioController *candidateControllers.CandidatePortfolioController, appConfig *config.AppConfig) {
    ...
    RegisterProtectedRoutes(protected, userController, candidateController, personalInfoController, educationController, experienceController, skillsController, certificationsController, portfolioController)
}
